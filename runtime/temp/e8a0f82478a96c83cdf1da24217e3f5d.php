<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/pc/rainbow/goods\goodsInfo.html";i:1508135092;s:40:"./template/pc/rainbow/public\header.html";i:1507883317;s:40:"./template/pc/rainbow/public\footer.html";i:1507883317;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1507883317;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
						...
						<div class="item">
							...
							<div class="cata-nav-layer">
								...
								<div class="advertisement_down">
									<?php $pid =10+$kr;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1508133600 and end_time > 1508133600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
                ...
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        ...
                        <ul>
                                ...
                                <li><span class="fullminus"><?php echo $goods['mission']; ?></span></li>
                        </ul>
                    </div>
