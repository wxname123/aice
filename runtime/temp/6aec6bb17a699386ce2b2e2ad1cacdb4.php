<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/pc/rainbow/cart\cart4.html";i:1509611278;s:45:"./template/pc/rainbow/public\sign-header.html";i:1509676922;s:40:"./template/pc/rainbow/public\footer.html";i:1507883317;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="erhuh">
                ...
                <p class="succ-p">
                    <?php if($master_order_sn != ''): ?>
                        ...
                        商品金额（元）：<b><?php echo $total_amount; ?></b>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                        付款金额（手续费）：&nbsp;&nbsp;<b>3000</b>&nbsp;<b>元</b>

                        <?php else: ?>
                        订单号：&nbsp;&nbsp;<?php echo $order['order_sn']; ?>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                        商品金额（元）：<b><?php echo $order['total_amount']; ?></b>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
                        付款金额（手续费）：&nbsp;&nbsp;<b>3000</b>&nbsp;<b>元</b>
                    <?php endif; ?>
                </p>
                <div class="succ-tip">
