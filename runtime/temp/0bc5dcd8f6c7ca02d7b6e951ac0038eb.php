<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"./template/mobile/new2/user\login.html";i:1509106519;s:41:"./template/mobile/new2/public\header.html";i:1506391061;s:45:"./template/mobile/new2/public\header_nav.html";i:1506391061;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    ...
    <?php endif; if($v['code'] == 'qq' AND is_qq() != 1): ?>
        <li>
            <a class="ta-qq" href="<?php echo U('LoginApi/login',array('oauth'=>'qq')); ?>" target="_blank" title="QQ">
                <div class="icon">
                    <!--<iconimg src="__STATIC__/images/qq.png"/>-->
                    <!--<p>qq登陆</p>-->
                </div>
            </a>
        </li>
