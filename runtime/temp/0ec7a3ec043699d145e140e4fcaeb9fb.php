<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/mobile/new2/goods\goodsInfo.html";i:1509420675;s:41:"./template/mobile/new2/public\header.html";i:1506391061;s:42:"./template/mobile/new2/public\top_nav.html";i:1506391061;s:43:"./template/mobile/new2/public\wx_share.html";i:1506391061;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    ...
    <div class="de_font p">
        <div class="thirty">
            ...
            <div class="scunde p">
                ...
                <p><span style="color:#999999">任务数：</span><span class="red"><?php echo $goods['mission']; ?></span></p>
            </div>
        </div>
    </div>
    ...
    <div class="sg" style="display: none;">
        <div class="spxq p">
            <table class="de_table" border="1" bordercolor="#cbcbcb" style="border-collapse:collapse;">
                ...
                <?php if($goods_attr_list == null): ?>
                    <td ><p>实际参数以商品车为准</p>
                        <small style="color: #999999">(解释权归公司所有)</small>
                    </td>
                <?php endif; if(is_array($goods_attr_list) || $goods_attr_list instanceof \think\Collection || $goods_attr_list instanceof \think\Paginator): if( count($goods_attr_list)==0 ) : echo "" ;else: foreach($goods_attr_list as $k=>$v): ?>
                    <tr>
    ...
    <div class="cart-concert-btm p">
        ...
        <div class="fr">
            <ul>
                ...
                <?php if(($statu == 0)): ?>
                    <li class="r">
                        <a  class="pb_buy dis_btn" href="javascript:;" onclick="mobile_SubmitCheck()">立即购买</a>
                    </li>
                    <?php elseif(($statu == 1)): ?>
                        <li class="r">
                            <a  class="pb_buy dis_btn" href="javascript:;" onclick="mobile_unpassCheck()">立即购买</a>
                        </li>
                    </elseif>
                    <?php elseif(($statu == 2)): ?>
                        <li class="r">
                            <a class="pb_buy dis_btn" href="javascript:;" onclick="AjaxAddCart(<?php echo $goods['goods_id']; ?>,1,1);">立即购买</a>
                        </li>
                    </elseif>
                    <?php elseif(($statu == 3)): ?>
                        <li class="r">
                            <a  class="pb_buy dis_btn" href="javascript:;" onclick="mobile_unselectIdentify">立即购买</a>
                        </li>
                    </elseif>
                    <?php else: ?>
                    <li class="r">
                        <a  class="pb_buy dis_btn" href="javascript:;" onclick="mobile_unlogin()">立即购买</a>
                    </li>
                <?php endif; ?>
            ...
            <div class="maleri30">
                <div class="shopprice">
                    ...
                    <div class="fon_or fl">
                        ...
                        <div class="dqkc_or"><span>任务数：</span><span style="color: red"><?php echo $goods['mission']; ?></span></div>
                    </div>
        ...
        <div class="shop-top-under p">
            <div class="maleri30">
                <div class="shulges p">
                    ...
                    <div class="plus">
                                <span class="mp_mp">
                        <input type="tel" class="num buyNum" id="number"  name="goods_num" value="1"   >
                                </span>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function  mobile_SubmitCheck(){
        location.href = "/index.php?m=mobile&c=User&a=Check";   //m=Home&c=User&a=check
    }

    //还没有通过验证
    function  mobile_unpassCheck(){
        layer.alert('您还没有通过管理员的认证！！！',{icon:5}) ;
    }

    //  数据查询失败
    function  mobile_unselectIdentify(){
        layer.alert('未找到该用户信息！！！',{icon:5}) ;
    }

    //没有登录
    function  mobile_unlogin(){
