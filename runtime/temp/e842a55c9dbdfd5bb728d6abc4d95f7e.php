<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/pc/rainbow/goods\goodsList.html";i:1509675023;s:40:"./template/pc/rainbow/public\header.html";i:1509706650;s:40:"./template/pc/rainbow/public\footer.html";i:1507883317;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1507883317;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
                            ...
                            <li>
                                <div class="s_xsall">
                                    ...
                                    <div class="J_btn_statu">
                                        ...
                                        <div class="p-btn">
                                            <a href="javascript:void(0);" onclick="AjaxAddCart(<?php echo $v[goods_id]; ?>,$('#number_'+<?php echo $v['goods_id']; ?>).val(),1);">立即购买</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
