<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./template/pc/rainbow/cart\ajax_pickup.html";i:1506391063;}*/ ?>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="1" class="address">
                  <tbody>
                      <tr>
                        ...
                        <td width="5%"  class="address_id"><input onclick="swidth_address(this)" type="radio" name="address_id" value="<?php echo $address_list['address_id']; ?>"/></td>
...
<?php endif; if(count($pickup_list) > 0): ?>
       <div class="order-address-list">
            <table width="100%" cellspacing="0" cellpadding="0" border="1" class="address">
              <tbody>
                  <tr>
...
<?php endif; if(\think\Request::instance()->param('show') == 1): ?>
<script>
