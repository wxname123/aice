<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./template/pc/rainbow/public\dispatch_jump.html";i:1506391063;s:40:"./template/pc/rainbow/public\header.html";i:1507629635;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
						...
						<div class="item">
							...
							<div class="cata-nav-layer">
								...
								<div class="advertisement_down">
									<?php $pid =10+$kr;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1507791600 and end_time > 1507791600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
