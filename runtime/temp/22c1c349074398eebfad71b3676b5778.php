<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/pc/rainbow/user\index.html";i:1507886655;s:38:"./template/pc/rainbow/user\header.html";i:1507883317;s:36:"./template/pc/rainbow/user\menu.html";i:1507883317;s:40:"./template/pc/rainbow/public\footer.html";i:1507883317;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
							...
							<li class="">
								<a href="<?php echo U('Home/User/mission'); ?>">
									<?php if($order != null): if(is_array($order) || $order instanceof \think\Collection || $order instanceof \think\Paginator): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
											...
											<em class="mu-num"><?php echo $list['mission']; ?></em>
											<i class="icon-ar"></i>
