<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/pc/rainbow/user\index.html";i:1508816152;s:38:"./template/pc/rainbow/user\header.html";i:1509620884;s:36:"./template/pc/rainbow/user\menu.html";i:1508833306;s:40:"./template/pc/rainbow/public\footer.html";i:1507883317;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="home-index-middle">
	...
	<div class="menu-ul">
		...
		<ul>
			...
			<li><a href="<?php echo U('Home/User/userList'); ?>">下级用户</a></li>
				...
				<div class="menu-ri-t p">
					...
					<div class="mu-afte fl">
						<ul class="mu-a1">
							...
							<li class="">
								<a href="<?php echo U('Home/User/mission'); ?>">
									<?php if($order != null): ?>
											<i class="icon-balance"></i>
											<span>提车任务数</span>
											<em class="mu-unit">&nbsp;台</em>
											<em class="mu-num"><?php echo $order['mission']; ?></em>
											<i class="icon-ar"></i>
										<?php else: ?>
										<i class="icon-balance"></i>
										<span>提车任务数</span>
										<em class="mu-unit">&nbsp;</em>
										<em class="mu-num" style="color: red">暂无</em>
									<?php endif; ?>
								</a>
							</li>
						</ul>
						<ul class="mu-a2">
							<li>
								<?php if($complete != null): ?>
									<i class="icon-point"></i>
									<span>已完成提车</span>
									<em class="mu-unit">&nbsp;台</em>
									<em class="mu-num"><?php echo $complete; ?></em>
									<i class="icon-ar"></i>
									<?php else: ?>
									<i class="icon-balance"></i>
									<span>已完成提车</span>
