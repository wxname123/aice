<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"./template/pc/rainbow/user\login.html";i:1506339769;s:40:"./template/pc/rainbow/public\footer.html";i:1503927244;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="loginsum_main" style="background: #bf1919;">
    <div class="w1224 p">
        <div class="advertisement">
            <?php $pid =9;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1506340800 and end_time > 1506340800 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
                ...
                <form id="loginform" method="post">
                    <div class="layel2">
                        <div class="text_uspa">
                            ...
                            <input type="text" autofocus="autofocus" class="text_cmu" value="" placeholder="手机号/邮箱" name="mobile" id="mobile" autocomplete="off">
                        </div>
                        <div class="text_uspa">
...
//       $('#loginform').serialize()  =>    mobile=admin&password=yuliang123&verify_code=
        $.ajax({
            type : 'post',
