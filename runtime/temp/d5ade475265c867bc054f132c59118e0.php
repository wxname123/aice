<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"./template/pc/rainbow/goods\search.html";i:1509620884;s:40:"./template/pc/rainbow/public\header.html";i:1509706650;s:40:"./template/pc/rainbow/public\footer.html";i:1507883317;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1507883317;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
				...
				<!--<script>-->
					...
					<!--function ajax_sales_goods() {-->
						<!--$.ajax({-->
							...
							<!--success: function (data) {-->
								<!--if(data){-->
									<!--$('#ajax_sales_goods')check3.html(data);-->
									<!--lazy_ajax();-->
								<!--}-->
							<!--}-->
						<!--});-->
