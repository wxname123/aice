...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline"  id="search-form3" onsubmit="return false">
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        ...
                        <input type="submit" class="btn" onclick="ajax_get_table('search-form3',1)" value="搜索">
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    function ajax_get_table(tab,page){
        ...
        $.ajax({
            type : "POST",
            url:"/index.php/Admin/user/ajaxmlist/p/"+page,//+tab,
    ...
    function sort(field)
    {
        ...
        ajax_get_table('search-form3',cur_page);
    }
    /**
     * 回调函数
     */
