<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./template/mobile/new2/user\index.html";i:1509106519;s:41:"./template/mobile/new2/public\header.html";i:1506391061;s:45:"./template/mobile/new2/public\footer_nav.html";i:1506391061;s:43:"./template/mobile/new2/public\wx_share.html";i:1506391061;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
        ...
        <div class="content">
            ...
            <div class="floor floor_order">
                <ul>
                    <li>
                        <a>
                            <span><?php echo $order['mission']; ?></span>
                            <img src="__STATIC__/images/q1.png" alt="" />
                            <p>我的任务</p>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo U('Mobile/User/mission'); ?>">
            ...
            <div class="floor list7 ma-to-20">
                <div class="myorder p">
                    <div class="content30">
                        <a href="<?php echo U('Mobile/User/agent'); ?>">
                            <div class="order">
                                <div class="fl">
